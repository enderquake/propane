...
public class MethaneSettings implements ConfigData {
    ...
    public boolean dynamicShading = false;
    ...
    public static class FogSettings{
        ...
        @Comment("Remove sky fog (render distance fog)")
        public boolean disableSkyFog = false;
        @Comment("Remove environmental fog (nether, water, lava, blindness, darkness)")
        public boolean disableEnvironmentalFog = false;
