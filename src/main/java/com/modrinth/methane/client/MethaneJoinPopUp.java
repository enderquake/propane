...
public class MethaneJoinPopUp extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
       ...
       MultilineText txt = MultilineText.create(textRenderer,Text.of("This server recommends certain methane settings. You can choose whether to follow these settings or not."));
